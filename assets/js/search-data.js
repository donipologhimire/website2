...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          description: "I taught two courses MAE 106 and MAE 52",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/donipologhimire", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=nqn7_SUAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
